...
@pytest.mark.parametrize('target_file, expected', [ 
    ('sample', [
        RFC822Email(source_ipv4='1.2.3.4', source_port='57523', envelope_from='bounce-134721-1973381@news.fundfire.com', envelope_to=['Some.User@host.com'], received=datetime(2020, 5, 14, 12, 29, 31, tzinfo=UTC), file_path='/tmp/pytest-of-ace/pytest-21/test_parse_bro_smtp0/smtp.0.email.rfc822'),
        RFC822Email(source_ipv4='1.2.3.4', source_port='57523', envelope_from='bounces+some.user=host.com@c.eddiebauer.com', envelope_to=['some.user@host.com'], received=datetime(2020, 5, 14, 12, 29, 31, tzinfo=UTC), file_path='/tmp/pytest-of-ace/pytest-21/test_parse_bro_smtp0/smtp.1.email.rfc822'),]),
